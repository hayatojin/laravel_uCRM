                                ...
                                <section class="text-gray-600 body-font relative">
                                    ...
                                    <div class="container px-5 py-6 mx-auto">
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="mt-3 p-2 w-full">
                                            <div class="">
                                                <label for="date" class="leading-7 text-sm text-gray-600">商品・サービス</label>
                                        ...
                                        <!-- item_nameとしてるのは、サブクエリで設定したエイリアスがデータとして入っており、それを取ってくる必要があるから -->
                                            ...
                                            <div class="p-2 w-full">
                                            <div class="">
                                                <label for="price" class="leading-7 text-sm text-gray-600"></label>
